...
const Login = ({ navigation }) => {
  ...
  const handleLogin = (credentials, setSubmitting) => {
    ...
    handleMessage(null);
    const url = 'https://helpinhand-318217.ey.r.appspot.com/rest/authentication/login';
    axios
  ...
  return (
    <KeyboardAvoidingWrapper>
      <StyledContainer>
        ...
        <InnerContainer>
          <PageLogo resizeMode="cover" source={require('./../assets/img/HxP2.png')} />
              ...
              <StyledFormArea>
                ...
                {!googleSubmitting && (
                  <StyledButton onPress={handleGoogleSignin} google={true}>
                    ...
                    <ButtonText google={true}>Sign in com o Google</ButtonText>
                  </StyledButton>
                )}
                {googleSubmitting && (
                ...
                <ExtraView>
                  <ExtraText>Ainda não tens uma conta? </ExtraText>
